        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="name" placeholder="name" class="form-control" value="{$category->name}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="firstName" class="col-sm-3 control-label">Description</label>
                    <div class="col-sm-9">
                        <textarea rows="5" id="description" placeholder="Description" class="form-control">{$category->description}</textarea>
                    </div>
                </div>
                <div class="form-group">
